...
else if ($user_Type == 'Instructor')
{
   ...
   $sql = "SELECT * FROM attendance_report where faculty_school_id = '".$_SESSION['session_id']."' and fullcourse_name = '".$_SESSION['rsq2']."' and date_attended = '".$_SESSION['fdate']."' and attendance_check = 1";
            $result = mysqli_query($link,$sql) or die (mysqli_error());
