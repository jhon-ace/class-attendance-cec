                            ...
                            <form method="POST">
                                ...
                                <form method="POST">
                                    <?php
                                                         if(isset($_POST['dateSubmit']))
                                                         {
                                                            $fetchDisplay = $_POST['datepicker'];
                                                            $_SESSION['fdate'] = $fetchDisplay;

                                                            echo"<p>(1) Date Selected: <text style='color:red'><b>$fetchDisplay</b><br></text></p>";
                                ...
                                <form method="POST">
                                    ...
                                    <?php
                                                            ...
                                                            for($a = 0 ; $a < $num_rows = mysqli_fetch_array($resultT) ; $a++ )
                                                            {
                                                                ...
                                                                if(mysqli_num_rows($resultT) != 0) 
                                                                {
                                                                    $sql2 = mysqli_query($link, "SELECT COUNT(attendance_check ) AS 'TOTAL_PRESENT' FROM attendance_report where fullcourse_name = '".$_SESSION['rsq2']."' and attendance_check = 1 and date_attended = '".$_SESSION['fdate']."' and faculty_school_id = '".$_SESSION['session_id']."'");
                                                                     $sqlpo = "SELECT * FROM attendance_report where fullcourse_name = '".$_SESSION['rsq2']."' and attendance_check = 1 and date_attended = '".$_SESSION['fdate']."' and faculty_school_id = '".$_SESSION['session_id']."'";
                                                    ...
                                                    ?>
                                                                        ...
                                                                        &nbsp;Course Selected: <b style="color:red"><?php echo $_SESSION['rsq2']; ?></b><br><br>
                                                ...
                                                <?php
                                                             $sqlp = "SELECT * FROM attendance_report where fullcourse_name = '".$_SESSION['rsq2']."' and date_attended = '".$_SESSION['fdate']."'";
                                                            $result = mysqli_query($link, $sqlp);

                                                            if(mysqli_num_rows($result) > 0 ) 
                                                            {
                                                ?>
                                                                <h6 style="text-align:center;color:#FF9200;"><b>Attendance</b></h6>
                                                <?php
                                                                if(mysqli_num_rows($resultT) != 0) 
                                                                {
                                                ...
                                                <?php
                                                                       ...
                                                                       echo '<table id="instructor_csd_class_load_present" class="table table-hover  flex-nowrap" style="width:100%">';
                                                                        echo '<thead>';
                                                                        echo '<tr>
                                                                            <th></th>
                                                                            <th></th>
                                                ...
                                                ?>
                                                    <br>
                                                    <hr class="my-auto">
                                                    <br><h6 style="text-align:center;color:#FF9200;"><b>Attendance</b></h6>
                                                    <?php
                                                            if(mysqli_num_rows($resultT) != 0) 
                                                                    {
                                                    ...
                                                    <?php
                                                            ...
                                                            echo '<table id="instructor_csd_class_load_absent" class="table table-hover  flex-nowrap" style="width:100%">';
                                                                echo '<thead>';
                                                                    echo '<tr>
                                                                        <th></th>
                                                                        <th></th>
                                                            ...
                                                            echo "</table>"; 
                                                                ...
                                                                {
                                                                echo "<br><h5 style='text-align:center'>No data available</h5><br>";
                                                            }
                                                        }
