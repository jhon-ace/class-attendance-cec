...
<nav id="sidebar" style="background-color: #373333 !important" class="">
                <div class="p-4 pt-5 sticky-top">
                    <a href="#" class="img logo rounded-circle mb-5" style="background-image: url(images/user.png);"></a>
                            <p style="margin-top:-20px;margin-bottom: 5px">Welcome, <text style="color:#FF9200;"><b style="text-transform: uppercase;"><?=$userlname;?> (<?=$user_school_id;?>)</b></text></p>
                        ...
                        <div class="footer text-center" style="margin-top:60px">
                            <p>This system was made by Computer Studies Department</p>
                        </div>
                </div>
            </nav>
