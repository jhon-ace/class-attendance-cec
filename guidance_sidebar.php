<nav id="sidebar" style="background-color: #373333 !important" class="">
                <div class="p-4 pt-5 sticky-top">
                        <a href="#" class="img logo rounded-circle mb-5" style="background-image: url(<?php echo $user_image;?>);"></a>
                            <p style="margin-top:-20px;margin-bottom: 5px">Welcome, <text style="color:#FF9200;"><b style="text-transform: uppercase;"><?=$userlname.", ".$userfname;?> (FA 110697 061719)</b></text></p>
                        <hr class="my-auto" style="border: 0; border-top: 1px solid #ccc;"><br>
                            <ul class="list-unstyled components mb-5">
                                ...
                                <li>
                                    <a href="course_csd.php"><i class="fa fa-user" aria-hidden="true"></i> Faculty Load</a> 
                                </li>
                                <li>
                                    <a href="students-csd.php"><i class="fa fa-user" aria-hidden="true"></i> Class List</a>  
                                </li>
